...
ADD CONSTRAINT fk_bloccati_utenti FOREIGN KEY BLOCCATI(ID_utente) REFERENCES UTENTI(ID)
ON DELETE NO ACTION;
ALTER TABLE `INBOOK`.`BLOCCATI`
ADD CONSTRAINT fk_bloccati_amministratori FOREIGN KEY BLOCCATI(ID_amministratore) REFERENCES UTENTI(ID)
ON DELETE NO ACTION;
