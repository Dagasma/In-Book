...
module.exports = app => {
    ...
    router.get("/findAllFornitore_unione/:id_fornitore",config.keycloak.protect('realm:fornitore'), middleware_check.check_id_param("id_fornitore"),notifiche.findAllFornitore_unione)
    router.get("/findAllcliente_unione/:id_cliente",config.keycloak.protect('realm:cliente'),middleware_check.check_id_param("id_cliente"),notifiche.findAllcliente_unione)
